...
<div class="lrs" style="background: #004b9c;">
RAIL CONSULTING 	
</div>
	<div style="text-align:left; font-size: 14px; padding: 20px; ">
	<img src="img/s2.jpg" width="250px" style="float: left; margin: 15px 35px 200px 0;"/>
	<?php echo $RAILCONSULTING; ?>
