...
<div class="lrs" style="background: #00b48e;">
	RAIL FORWARDING
	
</div>
<div style="text-align:left; font-size: 14px; padding: 20px; ">
<img src="img/s1.jpg" width="250px" style="float: left; margin: 15px 35px 200px 0;"/>
<?php echo $RAILFORWARDING; ?>
