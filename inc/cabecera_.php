...
<div id="franja">
	<div id="cabecera">
		...
		<div class="subtitulo"><?php echo $TITULO_BAJO_LOGO; ?></div>
		<span class="datos">
		...
		<div class="menu">
			...
			<a href="servicios.php" <?php if($page==2) echo "class='selected'"; ?>><?php echo $SERVICIOS; ?></a>
			<a href="terminales.php" <?php if($page==3) echo "class='selected'"; ?>><?php echo $TERMINALES; ?></a>
			<a href="http://www.transportuarios.com/<?php echo $lang; ?>" target="_blank" ><?php echo $SOBRE_NOSOTROS; ?></a>
