...
<title>RAIL OPERATOR AGENCY	</title>
...
<div class="lrs" style="background:#ff003b;">
RAIL OPERATOR AGENCY	
</div>
<div style="text-align:left; font-size: 14px; padding: 20px; ">
<img src="img/s3.jpg" width="250px" style="float: left; margin: 15px 35px 200px 0;"/>
<?php echo $RAILOPERATOR; ?>
